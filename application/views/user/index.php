      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="<?= base_url('user'); ?>">
...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-4 text-gray-800">Students Profile</h1>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-8">
        <div class="card-body">
          ...
          <p class="card-text">ID : <?= $user['nim']; ?></p>
          <p class="card-text"><?= $user['email']; ?></p>
          <p class="card-text"><small class="text-muted">Account created since <?= date('d F Y', $user['date_created']) ?></small></p>
        </div>
      </div>
    </div>
  </div>
